...
namespace Acolyte.Tests.Linq
{
    public sealed class AsyncEnumerable_SafeParallelForEachAwaitAsyncTests
    {
        ...
        [Fact]
        public async Task SafeParallelForEachAwaitAsync_AsyncEnumerable_ForNullValue_ShouldFail()
        {
            // Arrange.
        ...
        [Fact]
        public async Task SafeParallelForEachAwaitAsync_AsyncEnumerable_WithIndex_ForNullValue_ShouldFail()
        {
            // Arrange.
            const IAsyncEnumerable<int>? nullValue = null;
        ...
        [Fact]
        public async Task SafeParallelForEachAwaitAsync_AsyncEnumerable_WithSelector_ForNullValue_ShouldFail()
        {
            // Arrange.
            const IAsyncEnumerable<int>? nullValue = null;
        ...
        [Fact]
        public async Task SafeParallelForEachAwaitAsync_AsyncEnumerable_WithSelectorAndIndex_ForNullValue_ShouldFail()
        {
            // Arrange.
            const IAsyncEnumerable<int>? nullValue = null;
