...
namespace Acolyte.Common
{
    ...
    [Obsolete("Use \"Acolyte.Numeric.DoubleExtensions\" instead. This class will be remove in next major version.", error: false)]
    public static class DoubleExtensions
    {
        /// <inheritdoc cref="Numeric.DoubleExtensions.IsEqual(double, double)" />
        [Obsolete("Use \"Acolyte.Numeric.DoubleExtensions.IsEqual\" instead. This method will be remove in next major version.", error: false)]
